...
def setup(mspath: Annotated[str, Argument(help="Directory where MSes are located.")],
    solset: Annotated[str, typer.Option(parser=cwl_file, help="The solution tables generated by the LINC target pipeline in an HDF5 format.")],
linc: Annotated[str, typer.Option(parser=cwl_dir, help="The installation directory for the LOFAR INitial calibration pipeline.")],
filter_baselines: Annotated[Optional[str], typer.Option(help="The default filter constraints for the dp3_prep_target step.")] = "*&",
flag_baselines: Annotated[Optional[List[str]], typer.Option(help="The baselines to be flagged by DP3. Can be a pattern, e.g. [ CS013HBA*&&* ].")] = [],
phasesol: Annotated[Optional[str], typer.Option(help="The name of the target solution table to use from the solset input.")] = "TGSSphase",
min_separation: Annotated[Optional[int], typer.Option(help="The minimal accepted angular distance to an A-team source on the sky in degrees.")] = 30,
number_cores: Annotated[Optional[int], typer.Option(help="The minimum number of cores that should be available for steps that require high I/O.")] = 12,
max_dp3_threads: Annotated[Optional[int], typer.Option(help="The maximum number of threads DP3 should use per process.")] = 5,
clip_sources: Annotated[Optional[List[str]], typer.Option(help="The patches of sources that should be flagged. These should be present in the LINC skymodel.")] = [
