export LIBDIR=/net/lofar1/data1/sweijen/software/LOFAR/2018_10_10 # Was installed with GCC 5.4.0, but seems to work.
export INSTALLDIR=/net/lofar1/data1/sweijen/software/test_dp3
...
export CMAKE_PREFIX_PATH=$PATH_AOFLAGGER:$PATH_ARMADILLO:$PATH_BOOST:$PATH_CASACORE:$PATH_CFITSIO:$PATH_DYSCO:$PATH_BLAS:$PATH_SUPERLU:$PATH_WCSLIB
export LD_LIBRARY_PATH=$PATH_SUPERLU/lib64:$LD_LIBRARY_PATH
