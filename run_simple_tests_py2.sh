...
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/losoto -h > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off}|| printf ${Red}"FAIL\n"${Color_Off}

printf ${Cyan}"LSMTool: "${Color_Off}
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/lsmtool -h > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off}|| printf ${Red}"FAIL\n"${Color_Off}
...
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/python -c "import casacore" > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off} || printf ${Red}"FAIL\n"${Color_Off}

printf ${Cyan}"LoSoTo: "${Color_Off}
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/python -c "import losoto" > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off} || printf ${Red}"FAIL\n"${Color_Off}

printf ${Cyan}"LOFARBeam: "${Color_Off}
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/python -c "import lofar.stationresponse" > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off} || printf ${Red}"FAIL\n"${Color_Off}

printf ${Cyan}"LSMTool: "${Color_Off}
singularity exec $SIMG /opt/lofar/pyenv-py2/bin/python -c "import lsmtool" > /dev/null 2>&1 && printf ${Green}"OK\n"${Color_Off} || printf ${Red}"FAIL\n"${Color_Off}
