...
if __name__ == '__main__':
    ...
    vlbiparser.add_argument('--ddf_solsdir', type=cwl_dir, default='null', help='Path to where ddf-pipeline solutions can be found (usually SOLSDIR).')
    vlbiparser.add_argument('--delay_calibrator', type=cwl_file, default='', help='A delay calibrator catalogue in CSV format.')
    vlbiparser.add_argument('--ddf_solset', type=cwl_file, default='null', help='The solution tables generated by the DDF pipeline in an HDF5 format.')
